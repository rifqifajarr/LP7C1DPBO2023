...
public class Controller extends KeyAdapter implements KeyListener
{
    ...
    private int flag; // variabel sbg penanda arah player
    ...
    public synchronized void keyPressed(KeyEvent e)
    {
        ...
        if(game.isRunning())
        {
            ...
            if((key == KeyEvent.VK_W) || (key == KeyEvent.VK_UP))
            {
                // Move up.
                temp.setVelY(-5);
                int s = game.getScore(); // get score yang sekarang
                if(this.flag != 1) game.setScore(s + 1); // kalo arah nya beda dgn yang sekarang, skor ditambah
                this.flag = 1; // ubah tanda arah jadi keatas
            }
            if((key == KeyEvent.VK_A) || (key == KeyEvent.VK_LEFT))
            {
                ...
                temp.setVelX(-5);
                int s = game.getScore();
                if(this.flag != 2) game.setScore(s + 1);
                this.flag = 2;
            }
            if((key == KeyEvent.VK_S) || (key == KeyEvent.VK_DOWN))
            {
                ...
                temp.setVelY(+5);
                int s = game.getScore();
                if(this.flag != 3) game.setScore(s + 1);
                this.flag = 3;
            }
            if((key == KeyEvent.VK_D) || (key == KeyEvent.VK_RIGHT))
            {
                ...
                temp.setVelX(+5);
                int s = game.getScore();
                if(this.flag != 4) game.setScore(s + 1);
                this.flag = 4;
            }
        }
    }
